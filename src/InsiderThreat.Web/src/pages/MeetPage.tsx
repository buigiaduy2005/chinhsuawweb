...
import {
    ...
    CheckOutlined, CloseOutlined, RiseOutlined,
                            ...
                            >
                                ...
                                <Space orientation="vertical" style={{ width: '100%' }} size="large">
                                    ...
                                    <div style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
                                        ...
                                        <Button size="large" icon={<VideoCameraAddOutlined />} onClick={handleCreateRoom} loading={loading}>
                                            {t('meet.btn_create', 'Tạo phòng mới')}
                                        </Button>
                                        <Button type="primary" size="large" icon={<EnterOutlined />} onClick={handleJoinRoom} loading={loading} disabled={!inputCode.trim()}>
                                    ...
                                    <div className={styles.rightPanel}>
                                        <Tabs
                                            ...
                                            items={[
                                                {
                                                    key: 'participants',
                                                    label: <><TeamOutlined /> Thành viên ({peers.size + 1})</>,
                                                    children: (
                                                ...
                                                {
                                                    key: 'chat',
                                                    label: <><MessageOutlined /> Chat {chatMessages.length > 0 && <Badge count={chatMessages.length} size="small" />}</>,
                                                    children: (
                                                ...
                                                {
                                                    key: 'transcript',
                                                    label: <><FileTextOutlined /> Transcript</>,
                                                    children: (
                                        ...
                                        />
                                        <Button size="small" style={{ position: 'absolute', top: 8, right: 8 }}
                                            onClick={() => setRightPanel(null)}>✕</Button>
                                    </div>
                                )}
                            </div>
